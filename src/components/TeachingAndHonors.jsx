      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {teaching.length ? (
          <RoughBox filter="sm" tilt="l" color="#0f766e" className="p-5">
            <h3 className="font-pen flex items-center gap-2 text-lg font-bold text-slate-900">
            ...
            <ul className="mt-3 space-y-2">
              {teaching.map((course) => (
                <li
                  key={course}
                  className="font-pen flex items-center gap-2 text-[15px] text-slate-600"
                >
            ...
            <ul className="mt-3 space-y-3">
              {honors.map((h) => (
                <li key={h.id} className="font-pen text-[15px]">
                  <p className="font-bold text-slate-700">{h.title}</p>
