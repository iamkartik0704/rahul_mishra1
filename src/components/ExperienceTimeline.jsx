            ...
            <li key={node.id} className="relative pl-14 pb-2">
              ...
              */}
              {i < experience.length - 1 && (
                <div
                  className="absolute left-[14px] top-[44px] bottom-[4px] flex w-5 flex-col text-slate-400"
                  aria-hidden="true"
                >
              ...
              >
                <Briefcase
                  className={`h-4 w-4 ${isCurrent ? 'text-blue-600' : 'text-slate-500'}`}
                />
              </span>
              ...
              >
                <div className="flex flex-wrap items-start justify-between gap-x-3 gap-y-1">
                  <h3 className="font-pen text-lg font-bold text-slate-900">{node.role}</h3>
                  <span
                ...
                <p className="font-pen mt-0.5 text-[15px] text-slate-500">{node.institution}</p>
              </RoughBox>
            </li>
          )
        })}
